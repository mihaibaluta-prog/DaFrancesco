...
export const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { nr: "53", name: { de: "Carpaccio di Manzo", it: "Carpaccio di Manzo", en: "Beef Carpaccio" }, desc: { de: "Rinderfilet, Rucola, Parmesan, Pizzabrot", it: "filetto di manzo, rucola, parmigiano, pane", en: "Beef fillet, rocket, parmesan, bread" }, price: "12,90 €" },
      { nr: "54", name: { de: "Scampi alla Mediterranea", it: "Scampi alla Mediterranea", en: "Mediterranean Scampi" }, desc: { de: "sechs Scampi auf grünem Salat, Weißbrot", it: "sei scampi su insalata verde, pane", en: "six scampi on green salad, white bread" }, price: "18,50 €" },
      { nr: "57", name: { de: "Antipasto Misto", it: "Antipasto Misto", en: "Mixed Antipasto" }, desc: { de: "gemischter Vorspeisenteller", it: "piatto misto di antipasti", en: "mixed starter platter" }, price: "13,00 €" },
      { nr: "59", name: { de: "Carpaccio di Tonno", it: "Carpaccio di Tonno", en: "Tuna Carpaccio" }, desc: { de: "hauchdünne Thunfischscheiben mit Rucola", it: "sottili fette di tonno con rucola", en: "thin tuna slices with rocket" }, price: "14,50 €" },
      { nr: "60", name: { de: "Carpaccio di Salmone", it: "Carpaccio di Salmone", en: "Salmon Carpaccio" }, desc: { de: "hauchdünne Lachsscheiben mit Rucola", it: "sottili fette di salmone con rucola", en: "thin salmon slices with rocket" }, price: "13,50 €" },
    ],
  },
  {
    id: "suppen",
