...
export const menuCategories: MenuCategory[] = [
  ...
  // ─── PIZZA ────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      { nr: "1",  name: { de: "Pizza Margherita", it: "Pizza Margherita", en: "Pizza Margherita" }, desc: { de: "mit Tomaten und Käse", it: "pomodoro e formaggio", en: "with tomato and cheese" }, price: "8,50 € / 10,00 €" },
      ...
      { nr: "8",  name: { de: "Pizza Mary", it: "Pizza Mary", en: "Pizza Mary" }, desc: { de: "mit Peperoniwurst, Salami und Champignons", it: "con salame piccante, salame e funghi", en: "with pepperoni, salami and mushrooms" }, price: "10,50 € / 12,00 €" },
      ...
      { nr: "10", name: { de: "Pizza Speciale", it: "Pizza Speciale", en: "Pizza Speciale" }, desc: { de: "mit Salami, Peperoniwurst, Formvorderschinken, Champignons und grüne Peperoni", it: "salame, salame piccante, prosciutto, funghi e peperoni verdi", en: "salami, pepperoni, ham, mushrooms and green peppers" }, price: "12,00 € / 13,50 €" },
      ...
      { nr: "13", name: { de: "Pizza Quattro Stagioni", it: "Pizza Quattro Stagioni", en: "Pizza Four Seasons" }, desc: { de: "mit Paprika, Salami, Formvorderschinken, Champignons und Spargel", it: "paprika, salame, prosciutto, funghi e asparagi", en: "peppers, salami, ham, mushrooms and asparagus" }, price: "12,00 € / 13,50 €" },
      { nr: "14", name: { de: "Pizza Piccante (scharf)", it: "Pizza Piccante", en: "Pizza Piccante (spicy)" }, desc: { de: "mit Peperoniwurst, Formvorderschinken, Champignons, Artischocken und grüne Peperoni", it: "salame piccante, prosciutto, funghi, carciofi e peperoni verdi", en: "pepperoni, ham, mushrooms, artichokes and green peppers" }, price: "12,00 € / 13,50 €" },
      ...
      { nr: "16", name: { de: "Pizza Capricciosa", it: "Pizza Capricciosa", en: "Pizza Capricciosa" }, desc: { de: "mit Formvorderschinken, Champignons, Artischocken und Paprika", it: "prosciutto, funghi, carciofi e paprika", en: "ham, mushrooms, artichokes and peppers" }, price: "12,00 € / 13,50 €" },
      ...
      { nr: "19", name: { de: "Pizza Calzone", it: "Pizza Calzone", en: "Pizza Calzone" }, desc: { de: "gefüllt mit Salami, Formvorderschinken, Champignons und Peperoniwurst", it: "ripiena di salame, prosciutto, funghi e salame piccante", en: "filled with salami, ham, mushrooms and pepperoni" }, price: "11,50 € / 13,00 €" },
      ...
      { nr: "21", name: { de: "Pizza Vesuvio (doppelt gefüllt)", it: "Pizza Vesuvio (doppio ripieno)", en: "Pizza Vesuvio (double-stuffed)" }, desc: { de: "mit Salami, Champignons, Formvorderschinken und Peperoniwurst", it: "salame, funghi, prosciutto e salame piccante", en: "salami, mushrooms, ham and pepperoni" }, price: "12,50 € / 14,00 €" },
      ...
      { nr: "31", name: { de: "Pizza della Casa", it: "Pizza della Casa", en: "Pizza della Casa" }, desc: { de: "mit Salami, Formvorderschinken, Champignons, Peperoniwurst, Paprika, grüne Peperoni, Spargel, Artischocken und Oliven", it: "salame, prosciutto, funghi, salame piccante, peperoni, asparagi, carciofi e olive", en: "salami, ham, mushrooms, pepperoni, peppers, asparagus, artichokes and olives" }, price: "14,00 € / 15,50 €" },
      ...
      { nr: "34", name: { de: "Pizza Stefano", it: "Pizza Stefano", en: "Pizza Stefano" }, desc: { de: "mit Formvorderschinken, Peperoniwurst und Mozzarella", it: "prosciutto, salame piccante e mozzarella", en: "ham, pepperoni and mozzarella" }, price: "11,00 € / 12,50 €" },
      ...
      { nr: "38", name: { de: "Pizza Vanessa", it: "Pizza Vanessa", en: "Pizza Vanessa" }, desc: { de: "mit Formvorderschinken, Peperoniwurst, Paprika, Champignons und Zwiebeln", it: "prosciutto, salame piccante, peperoni, funghi e cipolle", en: "ham, pepperoni, peppers, mushrooms and onions" }, price: "12,50 € / 14,00 €" },
    ],
  },
